...
use App\View\Cell\SDGCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\SDGCell Test Case
 */
class SDGCellTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->SDG = new SDGCell($this->request, $this->response);
    }
